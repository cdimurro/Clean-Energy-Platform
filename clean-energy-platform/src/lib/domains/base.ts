...
// Technology domain categories for assessment platform
export type DomainId =
  // Clean Energy
  | 'solar' | 'wind' | 'hydro' | 'geothermal' | 'nuclear'
  // Energy Storage
  | 'battery' | 'hydrogen' | 'thermal-storage' | 'pumped-hydro'
  // Industrial Decarbonization
  | 'ccs' | 'dac' | 'green-steel' | 'green-cement' | 'industrial'
  // Transportation
  | 'ev' | 'saf' | 'fuel-cell' | 'maritime' | 'transportation'
  // Agriculture & Food
  | 'vertical-farming' | 'precision-ag' | 'alt-protein' | 'agriculture'
  // Advanced Materials
  | 'materials' | 'rare-earth' | 'semiconductors'
  // Biotech
  | 'synthetic-biology' | 'gene-therapy' | 'biofuels' | 'biotech'
  // Computing
  | 'quantum' | 'neuromorphic' | 'computing'
  // Waste-to-Fuel
  | 'waste-to-fuel' | 'htl' | 'pyrolysis' | 'gasification'
  // Legacy/General
  | 'grid' | 'general'
...
// Map domains to their category
export const DOMAIN_CATEGORY_MAP: Record<DomainId, DomainCategory> = {
  // Clean Energy
  solar: 'clean-energy',
  wind: 'clean-energy',
  hydro: 'clean-energy',
  ...
  'precision-ag': 'agriculture',
  'alt-protein': 'agriculture',
...
// Primary metrics by domain category
export const CATEGORY_PRIMARY_METRICS: Record<DomainCategory, string[]> = {
  'clean-energy': ['LCOE', 'Capacity Factor', 'Efficiency', 'CAPEX/kW'],
  'energy-storage': ['LCOS', 'Round-Trip Efficiency', 'Cycle Life', 'CAPEX/kWh'],
  'industrial': ['LCOC', 'Carbon Intensity', 'Abatement Cost', 'Energy Intensity'],
  'transportation': ['TCO', '$/mile', 'Emissions Intensity', 'Range'],
  'agriculture': ['$/kg Yield', 'Land Use Efficiency', 'Water Efficiency', 'Energy/kg'],
  'materials': ['$/kg', 'Purity', 'Supply Risk', 'Processing Energy'],
  'biotech': ['COGS', 'Efficacy', 'Regulatory Timeline', 'Scale-Up Factor'],
  'computing': ['Performance/Watt', 'Error Rate', 'Cost/Operation', 'Coherence Time'],
  'waste-to-fuel': ['LCOF', 'Biocrude Yield', 'Energy Recovery', 'Carbon Intensity'],
  'general': ['NPV', 'IRR', 'Payback', 'ROI'],
}
