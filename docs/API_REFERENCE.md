# Clean Energy Platform API Reference

Complete API documentation for all backend endpoints in the Clean Energy Platform platform.
...
- Email: api@cleanenergyplatform.com

**API Status:**
- Status page: [status.cleanenergyplatform.com](https://status.cleanenergyplatform.com)
