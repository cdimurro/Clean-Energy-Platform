# Clean Energy Platform Developer Guide

Technical documentation for developers working on the Clean Energy Platform.
...
├── clean-energy-platform/                    # Main Next.js application
│   ├── src/
...
cd clean-energy-platform/clean-energy-platform
```
...
Create `.env.local` in the `clean-energy-platform/` directory:
...
4. Email: dev@cleanenergyplatform.com
...
- Email: security@cleanenergyplatform.com
